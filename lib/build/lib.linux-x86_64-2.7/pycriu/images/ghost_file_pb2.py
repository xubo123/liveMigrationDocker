...
_GHOST_FILE_ENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\322?\002 \001\322?\002(\001')),
    _descriptor.FieldDescriptor(
...
class ghost_file_entry(_message.Message):
...
_GHOST_FILE_ENTRY.fields_by_name['dev']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\322?\002 \001')
_GHOST_FILE_ENTRY.fields_by_name['rdev'].has_options = True
_GHOST_FILE_ENTRY.fields_by_name['rdev']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\322?\002 \001\322?\002(\001')
