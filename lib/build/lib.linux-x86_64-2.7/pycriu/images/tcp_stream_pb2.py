...
class tcp_stream_entry(_message.Message):
...
_TCP_STREAM_ENTRY.fields_by_name['opt_mask']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\322?\002\010\001')
