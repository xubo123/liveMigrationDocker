...
class timerfd_entry(_message.Message):
...
_TIMERFD_ENTRY.fields_by_name['flags']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\322?\002\010\001')
_TIMERFD_ENTRY.fields_by_name['settime_flags'].has_options = True
_TIMERFD_ENTRY.fields_by_name['settime_flags']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\322?\002\010\001')
