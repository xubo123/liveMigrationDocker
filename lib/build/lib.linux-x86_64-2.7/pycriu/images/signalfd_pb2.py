...
class signalfd_entry(_message.Message):
...
_SIGNALFD_ENTRY.fields_by_name['flags']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\322?\002\010\001')
_SIGNALFD_ENTRY.fields_by_name['sigmask'].has_options = True
_SIGNALFD_ENTRY.fields_by_name['sigmask']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\322?\002\010\001')
