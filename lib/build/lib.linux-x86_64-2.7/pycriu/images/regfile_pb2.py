...
_REG_FILE_ENTRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=_descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\322?\r\032\013rfile.flags')),
    _descriptor.FieldDescriptor(
...
class reg_file_entry(_message.Message):
...
_REG_FILE_ENTRY.fields_by_name['flags']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\322?\r\032\013rfile.flags')
