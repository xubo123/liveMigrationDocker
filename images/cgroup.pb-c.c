...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &cgroup_perms__descriptor);
...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &cgroup_prop_entry__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &cgroup_dir_entry__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &cg_controller_entry__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &cg_member_entry__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &cg_set_entry__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &cgroup_entry__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
{
  {
    ...
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(CgroupPerms, mode),
    NULL,
    NULL,
    0,            /* packed */
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_UINT32,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(CgroupPerms, uid),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_UINT32,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(CgroupPerms, gid),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
{
  {
    ...
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(CgroupPropEntry, name),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(CgroupPropEntry, value),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(CgroupPropEntry, perms),
...
{
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(CgroupDirEntry, dir_name),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_MESSAGE,
    PROTOBUF_C_OFFSETOF(CgroupDirEntry, n_children),
    PROTOBUF_C_OFFSETOF(CgroupDirEntry, children),
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_MESSAGE,
    PROTOBUF_C_OFFSETOF(CgroupDirEntry, n_properties),
    PROTOBUF_C_OFFSETOF(CgroupDirEntry, properties),
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_MESSAGE,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(CgroupDirEntry, dir_perms),
    &cgroup_perms__descriptor,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
{
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_STRING,
    PROTOBUF_C_OFFSETOF(CgControllerEntry, n_cnames),
    PROTOBUF_C_OFFSETOF(CgControllerEntry, cnames),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_MESSAGE,
    PROTOBUF_C_OFFSETOF(CgControllerEntry, n_dirs),
    PROTOBUF_C_OFFSETOF(CgControllerEntry, dirs),
    &cgroup_dir_entry__descriptor,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
{
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(CgMemberEntry, name),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_STRING,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(CgMemberEntry, path),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_OPTIONAL,
    PROTOBUF_C_TYPE_UINT32,
    PROTOBUF_C_OFFSETOF(CgMemberEntry, has_cgns_prefix),
    PROTOBUF_C_OFFSETOF(CgMemberEntry, cgns_prefix),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
{
  {
    ...
    PROTOBUF_C_TYPE_UINT32,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(CgSetEntry, id),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_MESSAGE,
    PROTOBUF_C_OFFSETOF(CgSetEntry, n_ctls),
    PROTOBUF_C_OFFSETOF(CgSetEntry, ctls),
...
{
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_MESSAGE,
    PROTOBUF_C_OFFSETOF(CgroupEntry, n_sets),
    PROTOBUF_C_OFFSETOF(CgroupEntry, sets),
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_MESSAGE,
    PROTOBUF_C_OFFSETOF(CgroupEntry, n_controllers),
    PROTOBUF_C_OFFSETOF(CgroupEntry, controllers),
