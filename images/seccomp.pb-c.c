...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &seccomp_filter__descriptor);
...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &seccomp_entry__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
{
  {
    ...
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(SeccompFilter, filter),
    NULL,
    NULL,
    0,            /* packed */
  ...
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(SeccompFilter, has_prev),
    PROTOBUF_C_OFFSETOF(SeccompFilter, prev),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
{
  {
    ...
    PROTOBUF_C_OFFSETOF(SeccompEntry, n_seccomp_filters),
    PROTOBUF_C_OFFSETOF(SeccompEntry, seccomp_filters),
