...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &sysctl_entry__descriptor);
...
{
  {
    ...
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(SysctlEntry, type),
  ...
  },
  {
    ...
    PROTOBUF_C_OFFSETOF(SysctlEntry, has_iarg),
    PROTOBUF_C_OFFSETOF(SysctlEntry, iarg),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(SysctlEntry, sarg),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
const ProtobufCEnumValue sysctl_type__enum_values_by_number[2] =
{
...
const ProtobufCEnumValueIndex sysctl_type__enum_values_by_name[2] =
{
  { "CTL_32", 1 },
  { "CTL_STR", 0 },
};
