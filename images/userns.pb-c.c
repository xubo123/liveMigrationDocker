...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &uid_gid_extent__descriptor);
...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &userns_entry__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
{
  {
    ...
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(UidGidExtent, first),
    NULL,
    NULL,
    0,            /* packed */
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_UINT32,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(UidGidExtent, lower_first),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    PROTOBUF_C_TYPE_UINT32,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(UidGidExtent, count),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
...
{
  {
    ...
    PROTOBUF_C_OFFSETOF(UsernsEntry, n_uid_map),
    PROTOBUF_C_OFFSETOF(UsernsEntry, uid_map),
  ...
  },
  {
    ...
    PROTOBUF_C_LABEL_REPEATED,
    PROTOBUF_C_TYPE_MESSAGE,
    PROTOBUF_C_OFFSETOF(UsernsEntry, n_gid_map),
    PROTOBUF_C_OFFSETOF(UsernsEntry, gid_map),
    &uid_gid_extent__descriptor,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
