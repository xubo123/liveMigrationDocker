...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &siginfo_entry__descriptor);
...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &signal_queue_entry__descriptor);
  return protobuf_c_message_get_packed_size ((const ProtobufCMessage*)(message));
}
...
{
  {
    ...
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(SiginfoEntry, siginfo),
    NULL,
    NULL,
    0,            /* packed */
...
{
  {
    ...
    PROTOBUF_C_OFFSETOF(SignalQueueEntry, n_signals),
    PROTOBUF_C_OFFSETOF(SignalQueueEntry, signals),
