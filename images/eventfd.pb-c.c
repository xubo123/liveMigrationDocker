...
{
  PROTOBUF_C_ASSERT (message->base.descriptor == &eventfd_file_entry__descriptor);
...
{
  {
    ...
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(EventfdFileEntry, id),
    NULL,
    NULL,
    0,            /* packed */
  ...
  },
  {
    ...
    PROTOBUF_C_TYPE_UINT32,
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(EventfdFileEntry, flags),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
  },
  {
    ...
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(EventfdFileEntry, fown),
  ...
  },
  {
    ...
    0,   /* quantifier_offset */
    PROTOBUF_C_OFFSETOF(EventfdFileEntry, counter),
    NULL,
    NULL,
    0,            /* packed */
    0,NULL,NULL    /* reserved1,reserved2, etc */
